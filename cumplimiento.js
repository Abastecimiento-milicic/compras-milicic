...
const CLASIF_PEDIDOS_COL = "GCCLASIFICACION";
const CLIENTE_COL = "CLIENTE";
const COMPRAS_NICO_COL = "COMPRASNICO";
const GC_OC_COL = "GRUPO DE COMPRA OC";
const GC_SOLPED_COL = "GRUPO DE COMPRA";
...
/* ============================
   ...
   ============================ */
const COLORS = {
  green: "#85cc5c",       // Verde - CUMPLIDO AT
  amber_crit: "#eab308",  // Amarillo/Naranja - CUMPLIDO FT CRITICO
  amber_light: "#fde047", // Amarillo claro - CUMPLIDO FT NO CRITICO
  ...
  blue: "#3767A6",        // Azul de contraste para Demora
...
window.addEventListener("DOMContentLoaded", () => {
  async function loadData() {
    console.log("Cargando reporte de cumplimiento compras...");
